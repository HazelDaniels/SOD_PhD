...
For more info go [here](https://gatkforums.broadinstitute.org/gatk/discussion/1601/how-can-i-prepare-a-fasta-file-to-use-as-reference)
...
```bash
for i in /nfs1/BPP/LeBoldus_Lab/user_folders/danieldi/ramorum_align/gVCF/*.gz; do readlink -f $i; done > gvcf.list
```
