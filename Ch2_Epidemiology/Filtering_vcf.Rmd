...
library(vcfR)
library(tidyverse)
vcf <- read.vcfR("C:/Users/hazel/Google Drive/_Ph.D. Forestry/Research/2018.06_SpatialAnalysis/ramorumNA1.vcf.gz")
raw.vcf <- nrow(vcf)
```
...
```
# NA1
# 447,886 Polymorphic sites
# 432,358 Biallelic sites
...
p <- p + scale_y_continuous(trans=scales::log2_trans(), 
                              ...
                              #minor_breakwritings=c(1:10, 2:10*10, 2:8*100)
                            )
